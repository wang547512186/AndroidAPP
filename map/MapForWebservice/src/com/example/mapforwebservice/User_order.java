...
public class User_order extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		SimpleAdapter adapter = new SimpleAdapter(this, getData(),
				...
				new String[] { "hotelName", "addressHotel", "orderimg",
						"beginDate", "orderPrice","orderId" }, new int[] {
						R.id.ordername, R.id.orderaddress, R.id.orderimg,
						R.id.orderdate, R.id.orderprice,R.id.orderidText });
